...
export function OrderSummary({ plan, promoApplied }) {
  ...
  return (
    <div className="order-summary-card" style={{ background: 'var(--panel-surface)', borderRadius: 24, padding: '30px 28px', border: '1px solid var(--border)', boxShadow: 'var(--shadow)' }}>
